...
class Configuration:
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            model_trainer_config = ModelTrainerConfig(trained_model_file_path=trained_model_file_path, model_config_file_path=model_config_file_path, base_accuracy=base_accuracy)
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_config = ModelEvaluationConfig(model_evaluation_file_path=model_evaluation_file_path, timestamp=self.time_stamp)
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            model_export_dir_path = os.path.join(
                ROOT_DIR, 
                model_pusher_config[MODEL_PUSHER_EXPORT_DIR_KEY],
                time_stamp
            )
            
            model_pusher_config = ModelPusherConfig(model_export_dir_path=model_export_dir_path)
